          ...
          <div className="container lg:col-span-2">
            <article className="bg-neutral-50 p-8 drop-shadow-xl rounded-xl my-8">
              ...
              <p className="mb-5">
                ...
                it would be quite impossible that she should fetch the entrance
                of the harbour.
              </p>
              ...
              <section>
                ...
                <p className="mb-5">
                  ...
                  mouth across the East Pier, where the shock was expected, and
                  men waited breathless. The wind suddenly shifted to the
              ...
              <section>
                ...
                <ul className="list-disc ml-5 mb-5">
                  <li className="mb-3">
                    The searchlight followed her, and a shudder ran through all
                    who saw her, for lashed to the helm was a corpse, with
                    drooping head, which swung horribly to and fro at each
                    motion of the ship.
                  </li>

                  <li className="mb-3">
                    No other form could be seen on deck at all. A great awe came
                    on all as they realised that the ship, as if by a miracle,
                    had found the harbour, unsteered save by the hand of a dead
                    man! However, all took place more quickly than it takes to
                    write these words.
                  </li>
                ...
                <p className="mb-3">
                  ...
                  vernacular--actually project over where the sustaining cliff
                ...
                <p className="mb-3">
                  ...
                  were either in bed or were out on the heights above. Thus the
                  coastguard on duty on the eastern side of the harbour, who at
                  once ran down to the little pier, was the first to climb on
                  board. The men working the searchlight, after scouring the
                  entrance of the harbour without seeing anything, then turned
                  the light on the derelict and kept it there.
                </p>
              </section>
            </article>
